	...
	factory: (require) => {
		...
		var MxpageApi = class {
			...
			*/
			...
			updateProject(id, patch) {
				return post(ROUTES.projectUpdate, {
					id,
					...patch
				});
			}
			...
			reorderAssets(projectId, orderedAssetIds) {
				return post(ROUTES.assetsReorder, {
					projectId,
					orderedAssetIds
				});
			}
			setMainAsset(projectId, assetId) {
				return post(ROUTES.assetSetMain, {
					projectId,
					assetId
				});
			}
			...
			saveAnalysis(projectId, analysis) {
				return post(ROUTES.analysisSave, {
					projectId,
					analysis
				});
			}
			translatePage(projectId, targetLanguage) {
				return post(ROUTES.translatePage, {
					projectId,
					targetLanguage
				});
			}
			listTasks(projectId, limit = 50) {
				return get(ROUTES.tasks, projectId ? {
					projectId,
					limit: String(limit)
				} : { limit: String(limit) });
			}
			...
			providerTest(channelId) {
				return post(ROUTES.providerTest, { channelId });
			}
			providerDiscover(channelId) {
				return post(ROUTES.providerDiscover, { channelId });
			}
			usage(params) {
				const search = {};
				for (const [key, value] of Object.entries(params)) if (value !== void 0 && value !== "") search[key] = String(value);
			...
			async batchCreate(items, options = {}) {
				...
				return post(ROUTES.batchCreate, {
					items: payload,
					...options
				});
			}
		...
		*/
		...
		function AnalysisView(props) {
			...
			const [name, setName] = (0, react.useState)(detail.project.name);
			const [platform, setPlatform] = (0, react.useState)(detail.project.platform);
			const [style, setStyle] = (0, react.useState)(detail.project.style);
			const [analysis, setAnalysis] = (0, react.useState)(() => ({ ...detail.analysis ?? {} }));
			const [notice, setNotice] = (0, react.useState)(null);
			const [confirmDelete, setConfirmDelete] = (0, react.useState)(false);
			const uploadInput = (0, react.useRef)(null);
			const uploadAssets = (0, react.useMemo)(() => detail.assets.filter((asset) => asset.type !== "GENERATED" && asset.type !== "EXPORTED"), [detail.assets]);
		...
		*/
		function BatchView(props) {
			...
			const [autoAnalyze, setAutoAnalyze] = (0, react.useState)(true);
			const [notice, setNotice] = (0, react.useState)(null);
		...
		*/
		function ExportView(props) {
			...
			const [notice, setNotice] = (0, react.useState)(null);
			const [jsonPreview, setJsonPreview] = (0, react.useState)(null);
		...
		*/
		...
		function MonitorView(props) {
			...
			const [successFilter, setSuccessFilter] = (0, react.useState)("all");
		...
		*/
		...
		function PlannerView(props) {
			...
			const [translateLang, setTranslateLang] = (0, react.useState)("en-US");
		...
		*/
		...
		const PROJECT_TABS = /* @__PURE__ */ new Set([
			"analysis",
			"planner",
			"editor",
			"export"
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [error ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Notice, {
							...
							busy,
							run
						}) : tab === "batch" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BatchView, {
							api,
							busy,
							run,
							onOpenProject: (id) => {
						...
						}) : tab === "monitor" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MonitorView, { api }) : !detail || !PROJECT_TABS.has(tab) ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(WelcomeUpload, {
							busy,
							dragOver,
							setDragOver,
							fileInput,
							onFiles: createProject
						}) : tab === "analysis" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AnalysisView, {
							api,
							detail,
							busy,
							run,
						...
						}) : tab === "export" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ExportView, {
							api,
							detail,
							busy,
							run
